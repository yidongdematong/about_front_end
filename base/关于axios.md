...
```
PS D:\my\about_front_end> npm install axios
...
只有 url 是必需的。如果未指定 method，请求将默认为 GET。
...
```
{
  ...
  // see options https://nodejs.cn/dist/latest-v12.x/docs/api/http.html#http_http_request_url_options_callback
  // see also https://nodejs.cn/blog/vulnerability/february-2020-security-releases/#strict-http-header-parsing-none
...
- 配置生效的优先级
  配置将按优先顺序合并。顺序先是 lib/defaults/index.js 中的库默认值，然后是实例的 defaults 属性，最后是请求的 config 参数。后者将优先于前者。
